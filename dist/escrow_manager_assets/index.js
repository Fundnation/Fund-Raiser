...
/***/ "./src/declarations/escrow_manager/escrow_manager.did.js":
/*!***************************************************************!*\
  !*** ./src/declarations/escrow_manager/escrow_manager.did.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const idlFactory = ({ IDL }) => {
    ...
    return IDL.Service({
        ...
        'createEscrowCanister': IDL.Func([ProjectId, IDL.Principal, IDL.Vec(NFTInfo), Time, IDL.Nat], [], []),
        'getProjectEscrowCanisterPrincipal': IDL.Func([ProjectId], [IDL.Opt(CanisterIdText)], ['query']),
...
/***/ "./src/declarations/escrow_manager/index.js":
/*!**************************************************!*\
  !*** ./src/declarations/escrow_manager/index.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "escrow_manager": () => (/* binding */ escrow_manager),
/* harmony export */   "idlFactory": () => (/* reexport safe */ _escrow_manager_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory)
/* harmony export */ });
...
/* harmony import */ var _escrow_manager_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./escrow_manager.did.js */ "./src/declarations/escrow_manager/escrow_manager.did.js");
...
const createActor = (canisterId, options) => {
    const agent = new _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.HttpAgent({ ...options === null || options === void 0 ? void 0 : options.agentOptions });
    ...
    return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_escrow_manager_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
        agent,
        canisterId,
 ...
 */
const escrow_manager = createActor(canisterId);
...
"use strict";
/*!*************************************************!*\
  !*** ./src/escrow_manager_assets/src/index.jsx ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_escrow_manager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/escrow_manager */ "./src/declarations/escrow_manager/index.js");
...
document.querySelector("form").addEventListener("submit", async (e) => {
    ...
    const greeting = await _declarations_escrow_manager__WEBPACK_IMPORTED_MODULE_0__.escrow_manager.greet(name);
